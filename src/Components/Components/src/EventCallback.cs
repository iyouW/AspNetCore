...
namespace Microsoft.AspNetCore.Components
{
    ...
    public readonly struct EventCallback
    {
        ...
        public EventCallback(IHandleAfterEvent receiver, MulticastDelegate @delegate)
        {
            Receiver = receiver;
            Delegate = @delegate;
        }
    ...
    public readonly struct EventCallback<T>
    {
        ...
        {
            return new EventCallback(Receiver ?? Delegate?.Target as IHandleAfterEvent, Delegate);
        }
    }
}
