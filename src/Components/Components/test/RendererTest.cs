...
namespace Microsoft.AspNetCore.Components.Test
{
    public class RendererTest
    {
        ...
        private class EventComponent : AutoRenderComponent, IComponent, IHandleAfterEvent
        {
            [Parameter]
        ...
        private class RendersSelfAfterEventComponent : IComponent, IHandleAfterEvent
        {
            [Parameter]
        ...
        private class BindPlusConditionalAttributeComponent : AutoRenderComponent, IHandleAfterEvent
        {
        ...
        private class OuterEventComponent : IComponent, IHandleAfterEvent
        {
            private RenderHandle _renderHandle;
